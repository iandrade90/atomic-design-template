...
const Select: React.FC<SelectProps> = ({
  ...
  const [optionRef, setOptionRef] = useState<React.RefObject<HTMLLIElement>[]>(
    []
  );
  ...
  const highlightedItem = (optionIndex: number | null) => {
  ...
  useEffect(() => {
    setOptionRef(options.map((_) => createRef<HTMLLIElement>()));
  }, [options.length]);
